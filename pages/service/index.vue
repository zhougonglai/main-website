        ...
        <div class="resolve bg-gray-100 flex items-end justify-center gap-x-10 mt-80 pb-10">
          <nuxt-link to="/service/resolve"
            ...
            <div class="card-content bg-white flex-1 p-5 flex flex-col">
              <div class="card-title text-2xl text-center">固定站新建与改造</div>
              <p class="card-desc leading-8 mt-5 flex-1">
          ...
          <nuxt-link to="/service/resolve"
            ...
            <div class="card-content bg-white flex-1 p-5 flex flex-col">
              <div class="card-title text-2xl text-center">车载监测测向系统</div>
              <p class="card-desc leading-8 mt-5 flex-1">
